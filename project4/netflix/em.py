...
def estep(X: np.ndarray, mixture: GaussianMixture) -> Tuple[np.ndarray, float]:
    ...
    for i in range(n):
        ...
        f[i,:] = pre_exp - norm/(2*var)  # This is the ith users log p(j|i) vector: (K,)
    ...
    log_posts = f -  logsums # This is the log of posterior prob. matrix
